    ...
    if request.method == "POST":
        ...
        try:
            ...
            customer = stripe.Customer.create(
                email = request.user.username, #set user email here from recorded object of previous info
                name = f'{request.user.first_name} {request.user.last_name}', #set full name of customer here
